  ...
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        <div className="mx-auto mb-4 flex ma-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-grey-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
      ...
      <div>
        <div className="relative isolate">
          <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            <div style={{
             ...
             className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem ] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9589fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.187rem]" />
          </div>
        ...
        <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            <div style={{
             ...
             className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem ] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9589fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.187rem]" />
          </div>
      </div>
    </div>
      ...
      <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
        ...
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2  border-zinc-300 py-2 pl-4 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
            <span className="text-sm font-md text-blue-600">Step 1</span>
            <span className="text-xl font-semibold">Sign up for an account</span>
            <span className="mt-2 text-zinc-700">
              Either starting out with a free plan or choose our <Link className="text-blue-700 underline-offset-2" href="/pricing">pro plan</Link>.
            </span>
          </div>
        </li>
        ...
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2  border-zinc-300 py-2 pl-4 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
            <span className="text-sm font-md text-blue-600">Step 2</span>
        ...
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2  border-zinc-300 py-2 pl-4 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
            <span className="text-sm font-md text-blue-600">Step 3</span>
